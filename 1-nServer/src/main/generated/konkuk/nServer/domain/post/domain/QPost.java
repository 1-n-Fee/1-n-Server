...
public class QPost extends EntityPathBase<Post> {
    ...
    public final ListPath<konkuk.nServer.domain.comment.domain.Comment, konkuk.nServer.domain.comment.domain.QComment> comments = this.<konkuk.nServer.domain.comment.domain.Comment, konkuk.nServer.domain.comment.domain.QComment>createList("comments", konkuk.nServer.domain.comment.domain.Comment.class, konkuk.nServer.domain.comment.domain.QComment.class, PathInits.DIRECT2);
