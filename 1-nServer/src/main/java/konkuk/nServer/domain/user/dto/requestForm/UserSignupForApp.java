...
public class UserSignupForApp {
    ...
    @Builder
    public UserSignupForApp(String accountType, String name, String phone, String role, String email, String nickname,
                            String major, String sexType, String oauthId, String password) {
